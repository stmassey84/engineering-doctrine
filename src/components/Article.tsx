      ...
      <header className={"mb-4 lg:mb-6 not-format"}>
        <address className={"flex items-center mb-6 not-italic"}>
          <div className={"inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white"}>
            <img className={"mr-4 w-16 h-16 rounded-full"} src={"images/1663371833626.jpeg"} alt={author} />
            <div>
              ...
              {date ? <p className={"text-base font-light text-gray-500 dark:text-gray-400"}>{date}</p> : null}
            </div>
          </div>
        </address>
